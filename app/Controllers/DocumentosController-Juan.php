...
<body>
  <div class='wrap'>
    ...
    public function generatePDF()
    {
        ...
        // Determinar qué función usar según el tipo de plantilla
        switch($plantillaID) {
            
            // ========== ANULACION ==========
            case 1: // ANULACION - PN
                $dataReplace = $this->fillDataTemplateAnulacionPN($loteID);
                break;
            
            // ========== COMPRAVENTA ==========
            case 2: // COMPRAVENTA - PJ
                $dataReplace = $this->fillDataTemplateCompraventaPJ($loteID);
                break;
            case 3: // COMPRAVENTA - PN
                $dataReplace = $this->fillDataTemplateCompraventaPN($loteID);
                break;
            case 4: // COMPRAVENTA - PN_CONYUGE
                $dataReplace = $this->fillDataTemplateCompraventaPNConyuge($loteID);
                break;
            
            // ========== RESERVA ==========
            case 5: // RESERVA - PJ
                $dataReplace = $this->fillDataTemplateReservaPJ($loteID);
                break;
            case 6: // RESERVA - PN
                $dataReplace = $this->fillDataTemplateReservaPN($loteID);
                break;
            case 7: // RESERVA - PN_CONYUGE
                $dataReplace = $this->fillDataTemplateReservaPNConyuge($loteID);
                break;
            
            // ========== SEPARACION ==========
            case 8: // SEPARACION - PJ
                $dataReplace = $this->fillDataTemplateSeparacionPJ($loteID);
                break;
            case 9: // SEPARACION - PN
                $dataReplace = $this->fillDataTemplateSeparacionPN($loteID);
                break;
            case 10: // SEPARACION - PN_CONYUGE
                $dataReplace = $this->fillDataTemplateSeparacionPNConyuge($loteID);
                break;
